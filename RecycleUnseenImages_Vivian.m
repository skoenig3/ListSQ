% % Written December 29, 2014 by Seth Konig. DO NOT edit file!!!!
...
set_nums = ['A':'Q'  num2str([1:9]')']; %DO NOT edit line always start add more if needed
...
rand('seed',150107); %seed randomly so we can regenerate files if lost
%seed was 141019 updated by SDK 1/7/15
for i = 1:1000;
...
item_locatoins = new_crosshair_locations; %reassign cuz this is the variable the subsequent code uses
