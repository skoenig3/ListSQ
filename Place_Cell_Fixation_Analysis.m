    ...
    for c = 1:4
        for seq = 1:2
            ...
            if place_field_matrix(yloc,xloc) == 1 %item is in field
                ...
                if place_field_matrix(yloc-48,xloc) == 1&& place_field_matrix(yloc-48,xloc-48) == 1 &&...
                        place_field_matrix(yloc-48,xloc+48) == 1 && place_field_matrix(yloc+48,xloc) == 1 && ...
                        place_field_matrix(yloc+48,xloc-48) == 1 && place_field_matrix(yloc+48,xloc+48) == 1 && ...
                        place_field_matrix(yloc,xloc+48) == 1 && place_field_matrix(yloc,xloc-48) == 1
